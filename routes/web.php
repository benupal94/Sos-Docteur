...
Route::prefix('type_info')->group(function() {
Route::any('publication d\'une anonce', ['as' => 'type_info.news', 'uses' => 'Type_infoController@news']);
});
Route::resource('type_info', 'Type_infoController');


Route::prefix('info')->group(function() {
Route::any('liste des publications du mois', ['as' => 'info.liste', 'uses' => 'InfoController@liste']);
});
